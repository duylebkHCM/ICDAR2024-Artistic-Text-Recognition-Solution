...
from .encoder.vision_transformer import VisionTransformer, PatchEmbed
from .encoder.TextAdaIN import TextAdaIN
...
class Encoder(VisionTransformer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4.,
                 qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0., embed_layer=PatchEmbed, patch_drop_rate=0.0, adain=False):
        ...
        super().__init__(img_size, patch_size, in_chans, embed_dim=embed_dim, depth=depth, num_heads=num_heads,
                         ...
                         num_classes=0, patch_drop_rate=patch_drop_rate, adain=adain)  # these disable the classifier head
...
class SupConHead(nn.Module):
    ...
    def forward(self, x):
        ...
        feat = feat.reshape(bs, length, self.embed_dim)
        return feat